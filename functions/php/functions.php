...
function purchase($link, $productData, $sesID)
{
    ...
    // Wstawienie danych zamówienia do tabeli orders
    ...
    if ($stmtOrder) {
        ...
        if (mysqli_stmt_execute($stmtOrder)) {
            ...
            foreach ($productData as $product) {
                ...
                // Wstaw dane produktu do tabeli order_products
            ...
            echo "Błąd podczas wstawiania danych zamówienia: " . mysqli_error($link);
        }
